      ...
      <template #header>
        <div class="dashboard-header">
          <div class="header-left">
            <h1>个人仪表板</h1>
            <p>欢迎回来，{{ authStore.user?.real_name }}！</p>
          </div>
          <div class="header-right">
            <el-button @click="$router.push('/')" type="default">
              <el-icon>
                <House />
              </el-icon>
              返回首页
      ...
      <div class="dashboard-content">
        ...
        <el-card class="projects-card">
          ...
          <div v-else-if="dashboardData?.projects?.length" class="projects-list">
            <div v-for="project in dashboardData.projects.slice(0, 5)" :key="project.id" class="project-item"
              ...
              <div class="project-actions">
                <el-button size="small" @click.stop="$router.push(`/projects/${project.id}/mindmap`)">
                  打开思维导图
                </el-button>
              </div>
            </div>
...
import { Folder, Connection, User, House } from '@element-plus/icons-vue'
