      ...
      <div v-else-if="loginStep === 'face'">
        <div class="face-login-section">
          ...
          <div class="face-controls">
            <el-button v-if="!cameraStarted" type="primary" @click="startCameraAndAutoRecognize"
              :loading="cameraLoading">
              开始人脸识别
            </el-button>

            <div v-else class="face-buttons">
              <el-button v-if="!autoRecognizing" type="success" @click="startAutoRecognition" :loading="verifying">
                开始自动识别
              </el-button>

              <el-button v-if="autoRecognizing" type="warning" @click="stopAutoRecognition">
                停止识别
              </el-button>

              <el-button v-if="!autoRecognizing" type="info" @click="captureFace" :loading="verifying">
                手动识别
              </el-button>
