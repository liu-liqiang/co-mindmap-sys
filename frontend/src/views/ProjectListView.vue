      ...
      <div class="projects-content">
        ...
        <div v-else-if="projectStore.projects.length" class="projects-grid">
          <el-card v-for="project in projectStore.projects" :key="project.id" class="project-card"
            ...
            <div v-if="project.case_amount" class="project-amount">
              <el-icon>
                <Money />
              </el-icon>
              <span>涉案金额：{{ formatAmount(project.case_amount) }}</span>
            </div>
...
import { Plus, MoreFilled, User, Connection, Share, Money } from '@element-plus/icons-vue'
