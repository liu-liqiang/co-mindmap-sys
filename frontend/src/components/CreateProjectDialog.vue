<template>
  <el-dialog v-model="dialogVisible" title="创建新案件" width="600px" @close="handleClose">
    <el-form ref="formRef" :model="form" :rules="rules" label-width="100px">
      ...
      <el-form-item label="涉案金额" prop="case_amount">
        <el-input-number v-model="form.case_amount" :precision="2" :step="1000" :min="0" placeholder="请输入涉案金额"
          style="width: 100%">
...
const handleSubmit = async () => {
  ...
  try {
    ...
    // 添加涉案金额，如果有值的话
    if (form.case_amount !== null && form.case_amount !== undefined) {
      formData.append('case_amount', form.case_amount.toString())
    }
